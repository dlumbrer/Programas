...
\item \textbf{Ejercicio (discusión en clase):} ``Tipografía'' (ejercicio~\ref{subsec:tipografia})
\item \textbf{Ejercicio (entrega en el foro):} ``Creación de una cabecera de página'' (ejercicio~\ref{subsec:cabecera})
\end{itemize}
...
\item \textbf{Ejercicio (discusión en clase, entrega en GitHub):} ``Greasemonkey'' (ejercicio~\ref{subsec:eje-js-greasemonkey})
