...
\author{Jesús M. González Barahona, Gregorio Robles Martínez, Francisco Servant \\
...
\textbf{Aulas:} & Laboratorio 3208, Edif. Laboratorios III
\end{tabular}
...
\newcommand{\lunesAnl}{24 de enero} % no lectivo
\newcommand{\lunesB}{31 de enero}
\newcommand{\lunesC}{7 de febrero}
\newcommand{\lunesD}{14 de febrero}
\newcommand{\lunesE}{21 de febrero}
\newcommand{\lunesF}{28 de febrero}
\newcommand{\lunesG}{7 de marzo}
\newcommand{\lunesH}{14 de marzo}
\newcommand{\lunesI}{21 de marzo}
\newcommand{\lunesJ}{28 de marzo}
\newcommand{\lunesK}{4 de abril}
\newcommand{\lunesLnl}{11 de abril} % no lectivo
\newcommand{\lunesMnl}{18 de abril} % no lectivo
\newcommand{\lunesN}{25 de abril}
\newcommand{\lunesOnl}{2 de mayo} % no lectivo
\newcommand{\lunesP}{9 de mayo}
...
\newcommand{\juevesLnl}{14 de abril} % no lectivo
\newcommand{\juevesM}{21 de abril}
\newcommand{\juevesN}{28 de abril}
\newcommand{\juevesO}{5 de mayo}
\newcommand{\juevesPnl}{12 de mayo} % no lectivo
...
\begin{tabular}{|l|l|}
  ...
  \nameref{cal:lunesB} & \nameref{cal:juevesB} \\ 
  \nameref{cal:lunesBb} &                       \\  \hline
  \nameref{cal:lunesC} & \nameref{cal:juevesC} \\ 
  \nameref{cal:lunesCb} &  \\  \hline  
  \nameref{cal:lunesD} & \nameref{cal:juevesD} \\
  \nameref{cal:lunesDb} &  \\  \hline
  \nameref{cal:lunesE} & \nameref{cal:juevesE} \\ \hline
  \nameref{cal:lunesF} & \nameref{cal:juevesF} \\ \hline
  \nameref{cal:lunesG} & \nameref{cal:juevesG} \\ 
                       & \nameref{cal:juevesGb} \\ \hline
  \nameref{cal:lunesH} & \nameref{cal:juevesH} \\  \hline
  \nameref{cal:lunesI} & \nameref{cal:juevesI} \\
  \nameref{cal:lunesIb} & \nameref{cal:juevesIb} \\ \hline
  \nameref{cal:lunesJ} & \nameref{cal:juevesJ} \\
                       & \nameref{cal:juevesJb} \\ \hline
  \nameref{cal:lunesK} & \nameref{cal:juevesK} \\ \hline
                       &                      \\ \hline
                       & \nameref{cal:juevesM} \\ \hline
  \nameref{cal:lunesN} & \nameref{cal:juevesN} \\ \hline
                       & \nameref{cal:juevesO} \\ \hline
  \nameref{cal:lunesP} &                      \\ \hline
\end{tabular}
...
%%-----------------------------------------------------------------------
\subsubsection{\juevesA: Presentación  (1.5 horas)}
\label{cal:juevesA}
...
%%----------------------------------------------------------------
\subsubsection{\juevesG: Conceptos básicos VI (1 hora)}
\label{cal:juevesG}
...
%%----------------------------------------------------------------
\subsubsection{\juevesG: Interoperación web I (1 hora)}
\label{cal:juevesGb}
...
%%----------------------------------------------------------------
\subsubsection{\juevesI: Interoperación web III (1 hora)}
\label{cal:juevesI}
...
%%----------------------------------------------------------------
\subsubsection{\juevesI: MVC (1 hora)}
\label{cal:juevesIb}
...
%%----------------------------------------------------------------
\subsubsection{\juevesJ: MVC II (1 hora)}
\label{cal:juevesJ}
...
%%----------------------------------------------------------------
\subsubsection{\juevesJ: XML, JSON I (0.5 horas)}
\label{cal:juevesJb}
...
%%----------------------------------------------------------------
\subsubsection{\juevesK: XML, JSON II (2 horas)}
\label{cal:juevesK}
...
\item \textbf{Ejercicio:} ``Forks de un repositorio GitLab''
...
%%----------------------------------------------------------------
\subsubsection{\juevesN: CSS I (2 horas)}
\label{cal:juevesN}
...
%%----------------------------------------------------------------
\subsubsection{\juevesO: CSS II (2 horas)}
\label{cal:juevesO}
...
\item Presentacion de el proyecto final (enunciado en apartado~\ref{practica-final-2020-05}).
\end{itemize}
...
\end{itemize}
%%----------------------------------------------------------------------------
\subsubsection{\lunesB: Python I (1.5 horas)}
\label{cal:lunesBb}
...
%%----------------------------------------------------------------------------
\subsubsection{\lunesC: Python II (1.5 horas)}
\label{cal:lunesCb}
...
%%----------------------------------------------------------------------------
\subsubsection{\lunesD: Python III (1 hora)}
\label{cal:lunesD}
...
%%----------------------------------------------------------------------------
\subsubsection{\lunesD: Aplicaciones web I (1 hora)}
\label{cal:lunesDb}
...
%%----------------------------------------------------------------------------
%\subsubsection{\lunesF: Servidores simples I (2 horas)}
%\label{cal:lunesF}
...
%%%----------------------------------------------------------------------------
%\subsubsection{\lunesG: Servidores simples II (2 horas)}
%\label{cal:lunesG}
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio (discusión en clase):} ``Django Primera Aplicación'' (ejercicio~\ref{subsec:django-primera}).
  ...
  \item \textbf{Ejercicio (entrega en GitLab:} ``Django calc'' (ejercicio~\ref{subsec:django-calc}). \\
    Entrega recomendada: antes del \lunesG.
\end{itemize}
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio (entrega en GitLab):} ``Django cms\_put'' (ejercicio~\ref{subsec:django-cms-put}). \\
  Entrega recomendada: hasta el \lunesH.
\end{itemize}
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio (discusión en clase):} ``Django cms\_post'' (ejercicio~\ref{subsec:django-post}) \\
  ...
  Entrega recomendada: antes del \lunesI.
\end{itemize}


%%%----------------------------------------------------------------------------
\subsubsection{\lunesI: Django IV (0.5 horas)}
\label{cal:lunesI}
...
%%%----------------------------------------------------------------------------
\subsubsection{\lunesI: Django V (2 horas)}
\label{cal:lunesIb}
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio (discusión en clase):} ``Django cms\_users\_put'' (ejercicio~\ref{subsec:django-users-put}). \\
  Entrega recomendada: antes del \lunesJ.
\end{itemize}

%%%----------------------------------------------------------------------------
\subsubsection{\lunesJ: Django VI (2 horas)}
\label{cal:lunesJ}
...
%  \item \textbf{Presentación:} Posibilidades de feedparser.py
 ...
 \item \textbf{Material:} Transparencias ``Introducción a Django''
 \item \textbf{Ejercicio (discusión en clase):} ``Django cms\_post'' (ejercicio~\ref{subsec:django-post}).
  Entrega recomendada: antes del \lunesK.
...
%%%----------------------------------------------------------------------------
\subsubsection{\lunesK: Django VII (2 horas)}
\label{cal:lunesK}
...
%%----------------------------------------------------------------------------
 \subsubsection{\lunesN: Detalles finales I  (2 horas)}
 \label{cal:lunesN}
...
%%----------------------------------------------------------------
\subsubsection{\lunesP: Detalles finales II (2 horas)}
\label{cal:lunesP}
