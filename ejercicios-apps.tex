...
\section{Uso de la rama gh-pages}

La rama gh-pages en cualquier repositorio de GitHub tiene un significado especial: GitHab entenderá que ha de servir, como sitio web (esto es, como recursos HTTP) cualquier contenido que tenga esa rama. Por ejemplo, el contenido de la rama gh-pages del repositorio prueba del usuario jgbarah se podrá consultar con la siguiente url:
