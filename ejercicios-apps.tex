...
%%---------------------------------------------------------------------
%%---------------------------------------------------------------------
\section{Wifi abierta en instalaciones municipales en Madrid (mayo 2017)}

\label{sec:final-17-mayo}

La práctica consiste en la creación de una aplicación HTML5 que permita explorar los lugares en Madrid que cuentan con instalaciones municipales que ofrecen servicio \emph{wifi} grautito, a partir de ahora \emph{instalaciones}, construida a partir de los datos proporcionados por el propio ayuntamiento. Se trata de mostrar los datos de la forma más atractiva posible, incluyendo una descripción (campo descripción-entidad), fotos (FIXME: no hay), su localización en un mapa, etc. También se permitirá construir colecciones personales de instalaciones, y almacenarlas de forma persistente.
...
\begin{itemize}
  \item La descripción (campo descripción-entidad) de la instalación seleccionada (en la pestaña principal).
...
\begin{itemize}
  \item Fichero con los datos abiertos de instalaciones municipales con wifi: \\
  \url{http://datos.madrid.es/egob/catalogo/216619-0-wifi-municipal.json}
