...
Para crear esta rama, se pueden ejecutar las siguientes órdenes en la consola (se supone que ya se está en un repositorio de entrega de prácitcas, en el que se está trabajando en la rama master):
