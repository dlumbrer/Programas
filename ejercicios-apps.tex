...
\begin{itemize}
  ...
  \item Al principio se mostrará un botón para incluir usuarios de Google+. Al presionar el botón se abrirá una conexión con un servidor WebSocket que irá enviando identificadores de usuarios de Google+, que serán incluidos en esta zona según se vayan recibiendo. Los usuarios mostrados no deben aparecer repetidos.
