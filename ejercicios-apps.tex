...
\begin{enumerate}
  ...
  \item El código del servidor WebSocket se podrá descargar de \url{https://github.com/CursosWeb/PFinalWebSocketServer} y se ejecutarán de la siguiente manera desde la línea de comandos:
  
  \begin{verbatim}
     $ python PFinalWebSocketServer.py --port 12345
  \end{verbatim}
  
  donde el puerto podría ser cualquier otro. De hecho, depende de vuestra configuración, puede que tengáis que poner como puerto el 80, por lo que debéis lanzar el servidor con \emph{sudo}.
...
\begin{itemize}
  \item No se ha considerado ningún cambio.
\end{itemize}
...
%{\bf Convocatoria de junio:} viernes, 26 de junio, en la plataforma Moodle.
  ...
  \item \textbf{Fecha de revisión:} lunes, 4 de julio de 2017 a las 13:30.
%{\bf Convocatoria de junio:} martes, 30 de junio a las 13:30. Se requerirá a algunos alumnos que asistan a la revisión {\bf en persona}; se informará de ello en el mensaje de publicación de notas.
\end{itemize}
