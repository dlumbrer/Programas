...
\textbf{Aulas:} & Laboratorio 209, Edif. Laboratorios III (lunes) \\
\textbf{Aulas:} & Laboratorio 208, Edif. Laboratorios III (jueves) \\
\end{tabular}
...
\newcommand{\lunesA}{30 de enero}
\newcommand{\lunesB}{6 de febrero}
\newcommand{\lunesC}{13 de febrero}
\newcommand{\lunesD}{20 de febrero}
\newcommand{\lunesE}{27 de febrero}
\newcommand{\lunesF}{6 de marzo}
\newcommand{\lunesG}{13 de marzo}
\newcommand{\lunesH}{27 de marzo}
\newcommand{\lunesI}{17 de abril}
\newcommand{\lunesJ}{24 de abril}
\newcommand{\lunesK}{8 de mayo}
%\newcommand{\lunesK}{8 de mayo}
%\newcommand{\lunesKL}{2 de mayo}
...
%%-----------------------------------------------------------------------
\subsubsection{\juevesA: Presentación  (2 horas)}
\label{cal:juevesA}
...
%%----------------------------------------------------------------
\subsubsection{\lunesE: Interoperación web I (2 horas)}
\label{cal:lunesE}
...
%%----------------------------------------------------------------
\subsubsection{\lunesF: Interoperación web II (2 horas)}
\label{cal:lunesF}
...
%%----------------------------------------------------------------
\subsubsection{\lunesG: Interoperación web III (2 horas)}
\label{cal:lunesG}
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesB: Python I (0.5 horas)}
\label{cal:juevesB}
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesB: Lab remoto y Pycharm (1.5 horas)}
\label{cal:juevesBb}
