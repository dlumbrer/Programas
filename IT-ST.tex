...
\newcommand{\lunesA}{31 de enero}
\newcommand{\lunesB}{7 de febrero}
\newcommand{\lunesC}{14 de febrero}
\newcommand{\lunesD}{21 de febrero}
\newcommand{\lunesE}{28 de febrero}
\newcommand{\lunesF}{7 de marzo}
\newcommand{\lunesG}{14 de marzo}
\newcommand{\lunesH}{21 de marzo}
\newcommand{\lunesI}{28 de marzo}
\newcommand{\lunesJ}{4 de abril}
\newcommand{\lunesJK}{19 de abril}
\newcommand{\lunesK}{25 de abril}
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio (entrega en GitLab):} ``Django cms\_put'' (ejercicio~\ref{subsec:django-cms-put}). \\
  Entrega recomendada: hasta el \lunesI.
\end{itemize}
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio (discusión en clase):} ``Django cms\_users\_put'' (ejercicio~\ref{subsec:django-users-put}). \\
  Entrega recomendada: antes del \lunesJK.
\end{itemize}
...
%  \item \textbf{Presentación:} Posibilidades de feedparser.py
 ...
 \item \textbf{Material:} Transparencias ``Introducción a Django''
 \item \textbf{Ejercicio (discusión en clase):} ``Django cms\_post'' (ejercicio~\ref{subsec:django-post}).
  Entrega recomendada: antes del \lunesKL.
