...
%%-------------------------------------------------------------------------
%%-------------------------------------------------------------------------
\subsection{Django cms\_bootstrap sencillo}
...
\begin{itemize}
  ...
  \item El contenido se muestre en una rejilla (grid), con tres columnas: una con la llave, otra con el contenido y una tercera con un enlace a la página para modificar el contenido
\end{itemize}

Repositorio de entrega en GitLab: \\
\url{https://gitlab.etsit.urjc.es/cursosweb/practicas/server/django-cms-bootstrap1}
