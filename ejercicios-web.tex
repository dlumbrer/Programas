...
\textbf{Fecha recomendada de entrega:} Antes del \juevesH.
...
%%-----------------------------------------------------------------------------
%%-----------------------------------------------------------------------------
\subsection{Red social muy simple}
...
Crea un programa que haga funciones de calculadora simple. El programa tendrá dos funciones (sumar, restar). Cada función aceptará dos parámetros, y devolverá su suma o su direferencia. También tendrá un programa principal que llamará a esas funciones para sumar primero 1 y 2, y luego 3 y 4, mostrando en cada caso el resultado en pantalla. A continuación restará primero 5 de 6, y luego 7 de 8, mostrando tambén los resultados en pantalla. Entrega la práctica en el GitLab de la ETSIT, utlizando el repositorio de plantilla, como sigue:
...
Repositorio plantilla en GitLab para entrega del ejercicio (realizar un fork de él): \url{https://gitlab.etsit.urjc.es/cursosweb/xserv-contentapp}
...
\input{exa-sat-2022-06-23}

\input{exa-sat-2022-05-20}

\input{exa-saro-2022-06-28}

\input{exa-saro-2022-05-24}

\input{exa-st-2022-07-01}

\input{exa-st-2022-05-27}
