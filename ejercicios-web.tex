...
\begin{itemize}
  ...
  \item \textbf{Fecha de publicación de notas:} sábado, 25 de mayo de 2019, en la plataforma Moodle.
%{\bf Convocatoria de junio:} viernes, 26 de junio, en la plataforma Moodle.

  \item \textbf{Fecha de revisión:} lunes, 27 de mayo de 2019, probablemente a las 13:00 (se confirmará en el foro).
