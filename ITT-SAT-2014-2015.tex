...
\begin{itemize}
\item \textbf{Discusión de ejercicio (entrega en el foro):} ``Trackers en páginas web'' (ejercicio~\ref{subsec:trackers-paginas-web})  \\
...
\item \textbf{Discusión de ejercicio (entrega en el foro):} ``Cache de contenidos'' (ejercicio~\ref{subsec:cache-contenidos}). \\
