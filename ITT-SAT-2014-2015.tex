...
%%------------------------------------------------------------------------
\subsubsection{Sesión del 12 de enero (1 hora)}
...
\item \textbf{Discusión de ejercicio (entrega en el foro):} ``Última búsqueda'' (ejercicio~\ref{subsec:ultima-busqueda}) \\
  ...
  Entrega recomendada: antes del 23 de enero.
...
\item \textbf{Ejercicio propuesto (entrega en el foro):} ``Cookies en tu navegador'' (ejercicio~\ref{subsec:cookies-navegador}) \\
  Entrega recomendada: antes del 30 de enero.
\item \textbf{Ejercicio propuesto (sin entrega):} ``Cookies en tu navegador avanzado'' (ejercicio~\ref{subsec:cookies-navegador-2}) \\
%  Entrega recomendada: antes del 5 de febrero.
\item \textbf{Ejercicio propuesto (entrega en el foro):} ``Última búsqueda: números aleatorios o consecutivos'' (ejercicio~\ref{subsec:ultima-busqueda-aleconsec}) \\
  Entrega recomendada: antes del 30 de enero.
\end{itemize}
...
\begin{itemize}
\item \textbf{Ejercicio propuesto (entrega en el foro):} ``Sumador simple con varios navegadores intercalados'' (ejercicio~\ref{subsec:sumador-simple-varios-intercalados}) \\
...
\item \textbf{Ejercicio (entrega en el foro):} ``Trackers en páginas web'' (ejercicio~\ref{subsec:trackers-paginas-web}) \\
Entrega recomendada: antes del 13 de febrero.
\end{itemize}
...
%%----------------------------------------------------------------
\subsubsection{Sesión del ... (2 horaa)}

\begin{itemize}
\item \textbf{Presentación:} Arquitectura REST
\item \textbf{Material:} Transparencias, tema ``REST''
\item \textbf{Ejercicio propuesto (entrega en el foro)}: ``Una arquitectura distribuida'' (ejercicio~\ref{subsec:arq-distribuida}) \\
...
Implementación de lo discutido en la actividad anterior \\
Entrega recomendada: antes del 27 de febrero.
\end{itemize}


%%----------------------------------------------------------------
\subsubsection{Sesión del ... (1.5 horas)}
...
\begin{itemize}
\item \textbf{Discusión de ejercicio (entrega en el foro):} ``Calculadora simple versión REST'' (ejercicio~\ref{subsec:calc-simple-rest})  \\
 Entrega recomendada: antes del 13 de marzo.
\item \textbf{Ejercicio (entrega en el foro):} ``Sistema de transferencias bancarias'' (ejercicio~\ref{subsec:transferencias-bancarias}). \\
Entrega recomendada: antes del 13 de marzo.
\end{itemize}
...
\begin{itemize}
\item \textbf{Ejercicio:} ``Sistema REST para calcular Pi'' (ejercicio~\ref{subsec:rest-pi})
...
%%% %----------------------------------------------------------------
%\subsubsection{Sesión del 23 de abril}
%
...
\item \textbf{Material:} Ejercicios ``Introducción a Python'' (ejercicios~\ref{subsec:practicas-interprete}, \ref{subsec:ficheros-listas})
\item \textbf{Ejercicio propuesto (entrega en el foro):} ``Ficheros, diccionarios y excepciones'' (ejercicio~\ref{subsec:ficheros-dic-excep}).
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio propuesto (entrega en foro):} ``Clase servidor, varias aplis'' (ejercicio~\ref{subsec:clase-serv-aplis-varias}).
...
%
%\begin{itemize}
%  \item \textbf{Presentación:} Práctica final de la asignatura (\ref{practica-final-2013-05}).
%\end{itemize}
%
