...
\newcommand{\martesA}{9 de febrero}
\newcommand{\martesB}{16 de febrero}
\newcommand{\martesC}{23 de febrero}
\newcommand{\martesD}{2 de marzo}
\newcommand{\martesE}{16 de marzo}
\newcommand{\martesF}{23 de marxo}
\newcommand{\martesG}{6 de abril}
\newcommand{\martesH}{13 de abril}
\newcommand{\martesI}{20 de abril}
\newcommand{\martesJ}{27 de abril}
\newcommand{\martesK}{4 de mayo}
\newcommand{\martesL}{11 de mayo}
\newcommand{\martesM}{18 de mayo}
...
%%-----------------------------------------------------------------------
\subsubsection{\martesA: Presentación  (1 hora)}
\label{cal:martesA}
...
%%------------------------------------------------------------------------
\subsubsection{\martesA: Conceptos básicos I (0.5 horas)}
\label{cal:martesAc}
...
%%------------------------------------------------------------------------
\subsubsection{\juevesA: Conceptos básicos II (2 horas)}
\label{cal:juevesA}
...
%%----------------------------------------------------------------
\subsubsection{\juevesB: Conceptos básicos III (2 horas)}
\label{cal:juevesB}
...
%%----------------------------------------------------------------
\subsubsection{\juevesC: Conceptos básicos IV (2 horas)}
\label{cal:juevesC}
...
%%----------------------------------------------------------------
\subsubsection{\juevesD: Conceptos básicos V (2 horas)}
\label{cal:juevesD}
...
%%----------------------------------------------------------------
\subsubsection{\juevesE: Interoperación web I (2 horas)}
\label{cal:juevesE}
...
%%----------------------------------------------------------------
\subsubsection{\juevesF: Interoperación web II (2 horas)}
\label{cal:juevesF}
...
%%----------------------------------------------------------------
\subsubsection{\juevesG: Interoperación web III (2 horas)}
\label{cal:juevesG}
...
%%----------------------------------------------------------------
\subsubsection{\juevesI: XML, JSON I (2 horas)}
\label{cal:juevesI}
...
%%----------------------------------------------------------------------------
\subsubsection{\martesA: Laboratorio remoto, (0.5 horas)}
\label{cal:martesAb}
...
%%--------------------------------------------------------------------------
\subsubsection{\martesB: GitLab (0.5 horas)}
\label{cal:martesBb}
...
%%----------------------------------------------------------------------------
\subsubsection{\martesC: Python II (2 horas)}
\label{cal:martesC}
...
%%----------------------------------------------------------------------------
\subsubsection{\martesD: Python III (1 hora)}
\label{cal:martesD}
...
%%----------------------------------------------------------------------------
\subsubsection{\martesE: Aplicaciones web II (2 horas)}
\label{cal:martesE}
...
%%----------------------------------------------------------------------------
\subsubsection{\martesF: Servicores simples I (2 horas)}
\label{cal:martesF}
...
%%%----------------------------------------------------------------------------
\subsubsection{\martesG: Servicores simples II (2 horas)}
\label{cal:martesG}
...
%%%----------------------------------------------------------------------------
\subsubsection{\martesH: Django I (2 horas)}
\label{cal:martesH}
...
%%%----------------------------------------------------------------------------
\subsubsection{\martesK: Django IV (2 horas)}
\label{cal:martesK}
...
%%%----------------------------------------------------------------------------
\subsubsection{\martesL: Django V (2 horas)}
\label{cal:martesL}
...
%%%----------------------------------------------------------------------------
\subsubsection{\martesM: Django VI (2 horas)}
\label{cal:martesM}
