...
%%----------------------------------------------------------------------------
\subsubsection{\juevesB: GitLab (0.5 horas)}
\label{cal:juevesBb}

\begin{itemize}
\item Presentación del GitLab de la ETSIT, e interacción básica con él vía web.
\item Recursos: GitLab de la ETSIT, \url{gitlab.etsit.urjc.es}
\end{itemize}
