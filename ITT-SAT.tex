...
%%----------------------------------------------------------------
\subsubsection{Sesión del 22 de febrero (1 hora)}
...
\item \textbf{Ejercicio propuesto:} ``Clase servidor, cuatro aplis'' (ejercicio~\ref{subsec:clase-serv-aplis-varias}).
  \item Presentación de la primera práctica de entrega voluntaria (\ref{subsec:practica-vol-1-2016}). Entrega en GitHub. Fecha de entrega: antes del 8 de marzo.
\end{itemize}
