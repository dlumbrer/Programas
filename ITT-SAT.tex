...
%%----------------------------------------------------------------
\subsubsection{Sesión del 6 de febrero (2 horas)}
...
\item \textbf{Discusión de ejercicio:} ``Cache de contenidos versión Django'' (ejercicio~\ref{subsec:cache-contenidos-django}). \\
  Trabajo en grupos y discusión de los detalles del ejercicio.
   Entrega voluntaria. \\
   Repo GitLab: \url{https://github.com/CursosWeb/X-Serv-App-Cache-Django}
...
%%----------------------------------------------------------------------------
\subsubsection{Sesión del 11 de febrero (2 hora)}
...
\item \textbf{Ejercicio propuesto (entrega en GitLab):} ``Sumador simple'' (ejercicio~\ref{subsec:sumador-simple}) \\
...
% \item \textbf{Ejercicio:} ``Clase servidor, cuatro aplis'' (ejercicio~\ref{subsec:clase-serv-aplis-varias}).
 ...
 \item \textbf{Ejercicio:} ``Clase contentPostApp'' (ejercicio~\ref{subsec:contentpostapp}).
  \item Presentación de la primera práctica de entrega voluntaria (\ref{subsec:practica-vol-1-2016}). Entrega en GitLab. Fecha de entrega: antes del 13 de marzo.
\end{itemize}
