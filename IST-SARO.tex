...
\author{Gregorio Robles Martínez,  David Cortés Polo, \\
...
\begin{tabular}{|l|l|}
  ...
  \nameref{cal:martesG} & \nameref{cal:juevesG} \\
  \nameref{cal:martesGb} &                      \\ \hline
  \nameref{cal:martesH} & \nameref{cal:juevesH} \\ \hline
  \nameref{cal:martesI} & \nameref{cal:juevesI} \\ 
  \nameref{cal:martesIb} &                      \\ \hline
...
\item \textbf{Ejercicio propuesto (entrega en el foro):} ``Última búsqueda'' (ejercicio~\ref{subsec:ultima-busqueda})
...
\item \textbf{Ejercicio propuesto (entrega en el foro):} ``Servidores que recuerdan'' (ejercicio~\ref{subsec:servidores-recuerdan}) \\
...
\item \textbf{Ejercicio propuesto (entrega en el foro):} ``Cookies en tu navegador avanzado'' (ejercicio~\ref{subsec:cookies-navegador-2}) \\
...
\begin{itemize}
\item \textbf{Ejercicio (discusión en clase):} ``Servidores que recuerdan'' (ejercicio~\ref{subsec:servidores-recuerdan}) 
\item \textbf{Ejercicio (discusión en clase):} ``Cookies en tu navegador avanzado'' (ejercicio~\ref{subsec:cookies-navegador-2})
\item \textbf{Ejercicio propuesto:} ``Transplante de cookies 2'' (ejercicio~\ref{subsec:transplante-cookies2}) \\
\item \textbf{Ejercicio propuesto:} ``Traza de historiales de navegación por terceras partes'' (ejercicio~\ref{subsec:navegacion-terceras-partes})
\item \textbf{Ejercicio propouesto (entrega en el foro):}  ``Contador simple'' (ejercicio~\ref{subsec:contador-simple}) \\
...
%%----------------------------------------------------------------
\subsubsection{\martesG: Interoperación web I (1 hora)}
\label{cal:martesGb}
...
%%----------------------------------------------------------------
\subsubsection{\martesN: Clase final (1)}
\label{cal:martesN}
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesA: Python I (1.5 horas)}
\label{cal:juevesA}
...
\subsubsection{\juevesB: Lab remoto, PyCharm (0.5 horas)}
\label{cal:juevesBb}

\begin{itemize}
\item Mecanismos de conexión remota al laboratorio: VNC desde el navegador, ssh, etc.
\item Introducción al depurador de Python en PyCharm.
\end{itemize}

%%----------------------------------------------------------------------------
\subsubsection{\juevesC: Python III (1 horas)}
\label{cal:juevesC}

\begin{itemize}
\item \textbf{Presentación:} ``Introducción a Python''. Clases y orientación a objetos en Python.
\item \textbf{Material:} Transparencias ``Introducción a Python''
\item \textbf{Ejercicio propuesto (entrega en el campus virtual):} ``Descarga de documentos web'' (ejercicio~\ref{subsec:eje-python-descarga-web}).  
  Entrega recomendada: antes del \juevesD.

\end{itemize}

%%----------------------------------------------------------------------------
\subsubsection{\juevesC: Gitlab (1 hora)}
\label{cal:juevesCb}
...
\item \textbf{Ejercicio propuesto (entrega en GitLab):} ``Calculadora'' (ejercicio~\ref{subsec:calculadora}). Entrega recomendada: antes de \martesE.
...
\item \textbf{Ejercicio propuesto (entrega en GitLab:} ``Clase contentPostApp'' (ejercicio~\ref{subsec:contentpostapp}) \\
  Entrega recomendada: antes de \juevesG
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio (discusión en clase):} ``Django Primera Aplicación'' (ejercicio~\ref{subsec:django-primera}).
  ...
  \item \textbf{Ejercicio:} ``Django calc'' (ejercicio~\ref{subsec:django-calc}).
...
\begin{itemize}
 ...
 \item \textbf{Ejercicio (discusión en clase):} ``Django cms\_post'' (ejercicio~\ref{subsec:django-post}) \\
  ...
  Entrega recomendada: antes del \juevesJ.
\end{itemize}
...
\item \textbf{Ejercicio (discusión en clase):} ``Django tests en GitLab'' (ejercicio~\ref{subsec:django-tests-gitlab}).
\end{itemize}
