...
\newcommand{\martesK}{4 de abril}
\newcommand{\martesL}{18 de abril}
\newcommand{\martesM}{25 de abril}
\newcommand{\martesN}{2 de mayo}
\newcommand{\martesO}{9 de mayo}
...
\item \textbf{Ejercicio (entrega en el foro):} ``Explora tus cookies'' (ejercicio~\ref{subsec:explora-cookies}) \\
...
\item \textbf{Ejercicio propuesto (entrega en el foro:} ``Transplante de cookies 2'' (ejercicio~\ref{subsec:transplante-cookies2}) \\
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesA: Lab remoto (0.5 horas)}
\label{cal:juevesAa}
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesB: Python II (2 horas)}
\label{cal:juevesB}
...
%\item \textbf{Ejercicio propuesto (entrega en GitLab):} ``Calculadora'' (ejercicio~\ref{subsec:calculadora}). Entrega recomendada: antes de \juevesC.
\item \textbf{Ejercicio propuesto (entrega en foro):} ``Descarga de documentos web'' (ejercicio~\ref{subsec:eje-python-descarga-web}). Entrega recomendada: antes de \juevesC.
\end{itemize}
...
\item \textbf{Ejercicio propuesto (entrega en GitLab):} ``Calculadora'' (ejercicio~\ref{subsec:calculadora}). Entrega recomendada: antes de \juevesD.
