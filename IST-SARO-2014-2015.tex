...
\item \textbf{Ejercicio propuesto (discusión en clase):} ``Última búsqueda'' (ejercicio~\ref{subsec:ultima-busqueda}) \\
  Se introduce el problema, y se pide que trabajen sobre las interacciones HTTP invlucradas. Para la próxima sesión se deja la discusión sobre el uso de cookies (u otros mecanismos) para conseguir la funcionalidad requerida.
\end{itemize}
...
\item \textbf{Ejercicio propuesto (sin entrega):} ``Tablas de multiplicar'' (ejercicio~\ref{subsec:eje-python-tablas}).
\end{itemize}
...
\item \textbf{Material:} Transparencias ``Introducción a Python''
\item \textbf{Material:} Ejercicio ``Introducción a Python'' (ejercicios~\ref{subsec:practicas-interprete}).
\item \textbf{Ejercicios propuestos (entrega):} \ref{subsec:ficheros-listas} y~\ref{subsec:ficheros-dic-excep}.
\end{itemize}
...
\item \textbf{Presentación:} ``Introducción a Python''.
\item \textbf{Material:} Transparencias ``Introducción a Python''
\item \textbf{Ejercicio propuesto (entrega):} ``Calculadora'' (ejercicio~\ref{subsec:calculadora}).
\end{itemize}
